...
mixin _$PositionModel {
 ...
 String get symbol; String get side; double get size; double get avgPrice; double get markPrice; double get unrealisedPnl; double get leverage; int get positionIdx;
...
@useResult
$Res call({
 String symbol, String side, double size, double avgPrice, double markPrice, double unrealisedPnl, double leverage, int positionIdx
});
...
/// Create a copy of PositionModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? symbol = null,Object? side = null,Object? size = null,Object? avgPrice = null,Object? markPrice = null,Object? unrealisedPnl = null,Object? leverage = null,Object? positionIdx = null,}) {
...
as double,positionIdx: null == positionIdx ? _self.positionIdx : positionIdx // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String symbol,  String side,  double size,  double avgPrice,  double markPrice,  double unrealisedPnl,  double leverage,  int positionIdx)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PositionModel() when $default != null:
return $default(_that.symbol,_that.side,_that.size,_that.avgPrice,_that.markPrice,_that.unrealisedPnl,_that.leverage,_that.positionIdx);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String symbol,  String side,  double size,  double avgPrice,  double markPrice,  double unrealisedPnl,  double leverage,  int positionIdx)  $default,) {final _that = this;
switch (_that) {
case _PositionModel():
return $default(_that.symbol,_that.side,_that.size,_that.avgPrice,_that.markPrice,_that.unrealisedPnl,_that.leverage,_that.positionIdx);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String symbol,  String side,  double size,  double avgPrice,  double markPrice,  double unrealisedPnl,  double leverage,  int positionIdx)?  $default,) {final _that = this;
switch (_that) {
case _PositionModel() when $default != null:
return $default(_that.symbol,_that.side,_that.size,_that.avgPrice,_that.markPrice,_that.unrealisedPnl,_that.leverage,_that.positionIdx);case _:
  return null;
...
class _PositionModel implements PositionModel {
  const _PositionModel({required this.symbol, required this.side, required this.size, required this.avgPrice, required this.markPrice, required this.unrealisedPnl, required this.leverage, required this.positionIdx});
...
@override final  int positionIdx;
...
/// Create a copy of PositionModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? symbol = null,Object? side = null,Object? size = null,Object? avgPrice = null,Object? markPrice = null,Object? unrealisedPnl = null,Object? leverage = null,Object? positionIdx = null,}) {
