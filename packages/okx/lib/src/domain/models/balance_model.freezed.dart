...
mixin _$BalanceModel {
 ...
 double get totalEquity; List<CoinBalanceModel> get coins;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BalanceModel&&(identical(other.totalEquity, totalEquity) || other.totalEquity == totalEquity)&&const DeepCollectionEquality().equals(other.coins, coins));
}


@override
int get hashCode => Object.hash(runtimeType,totalEquity,const DeepCollectionEquality().hash(coins));

@override
String toString() {
  return 'BalanceModel(totalEquity: $totalEquity, coins: $coins)';
}
...
@useResult
$Res call({
 double totalEquity, List<CoinBalanceModel> coins
});
...
/// Create a copy of BalanceModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? totalEquity = null,Object? coins = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double totalEquity,  List<CoinBalanceModel> coins)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BalanceModel() when $default != null:
return $default(_that.totalEquity,_that.coins);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double totalEquity,  List<CoinBalanceModel> coins)  $default,) {final _that = this;
switch (_that) {
case _BalanceModel():
return $default(_that.totalEquity,_that.coins);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double totalEquity,  List<CoinBalanceModel> coins)?  $default,) {final _that = this;
switch (_that) {
case _BalanceModel() when $default != null:
return $default(_that.totalEquity,_that.coins);case _:
  return null;
...
class _BalanceModel implements BalanceModel {
  const _BalanceModel({required this.totalEquity, required final  List<CoinBalanceModel> coins}): _coins = coins;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BalanceModel&&(identical(other.totalEquity, totalEquity) || other.totalEquity == totalEquity)&&const DeepCollectionEquality().equals(other._coins, _coins));
}


@override
int get hashCode => Object.hash(runtimeType,totalEquity,const DeepCollectionEquality().hash(_coins));
...
/// Create a copy of BalanceModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? totalEquity = null,Object? coins = null,}) {
...
mixin _$CoinBalanceModel {
 ...
 String get coin; double get equity; double get cashBalance; double get usdValue; double get unrealisedPnl;
...
@override
int get hashCode => Object.hash(runtimeType,coin,equity,cashBalance,usdValue,unrealisedPnl);

@override
String toString() {
  return 'CoinBalanceModel(coin: $coin, equity: $equity, cashBalance: $cashBalance, usdValue: $usdValue, unrealisedPnl: $unrealisedPnl)';
}
...
@useResult
$Res call({
 String coin, double equity, double cashBalance, double usdValue, double unrealisedPnl
});
...
/// Create a copy of CoinBalanceModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? coin = null,Object? equity = null,Object? cashBalance = null,Object? usdValue = null,Object? unrealisedPnl = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String coin,  double equity,  double cashBalance,  double usdValue,  double unrealisedPnl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CoinBalanceModel() when $default != null:
return $default(_that.coin,_that.equity,_that.cashBalance,_that.usdValue,_that.unrealisedPnl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String coin,  double equity,  double cashBalance,  double usdValue,  double unrealisedPnl)  $default,) {final _that = this;
switch (_that) {
case _CoinBalanceModel():
return $default(_that.coin,_that.equity,_that.cashBalance,_that.usdValue,_that.unrealisedPnl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String coin,  double equity,  double cashBalance,  double usdValue,  double unrealisedPnl)?  $default,) {final _that = this;
switch (_that) {
case _CoinBalanceModel() when $default != null:
return $default(_that.coin,_that.equity,_that.cashBalance,_that.usdValue,_that.unrealisedPnl);case _:
  return null;
...
class _CoinBalanceModel implements CoinBalanceModel {
  const _CoinBalanceModel({required this.coin, required this.equity, required this.cashBalance, required this.usdValue, required this.unrealisedPnl});
...
/// Create a copy of CoinBalanceModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? coin = null,Object? equity = null,Object? cashBalance = null,Object? usdValue = null,Object? unrealisedPnl = null,}) {
